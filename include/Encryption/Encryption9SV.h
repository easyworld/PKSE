/**
 * Encryption9SV.h - Generation 9 Scarlet/Violet Pokemon Encryption/Decryption Utilities
 *
...
namespace Encryption {
     ...
     */
    constexpr size_t GAP_BOX_SLOT9_SV = 0x40;   // Gap after box Pokemon data
    constexpr size_t GAP_PARTY_SLOT9_SV = 0x88; // Gap after party Pokemon data (0x40 + 0x48)
     ...
     *
     * @param encryptedData The encrypted Pokemon data (SIZE_PARTY9_SV bytes)
     ...
     *
     * This is the reverse of decryptArray9SV, used when saving Pokemon data

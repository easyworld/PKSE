/**
 * Encryption8BDSP.cpp - Brilliant Diamond/Shining Pearl Pokemon Encryption/Decryption Implementation
 *
 * Implementation of encryption and decryption utilities.
 * See Encryption8BDSP.h for detailed documentation.
 */
...
namespace Encryption {
    ...
    std::byte* decryptArray8BDSP(std::span<const std::byte> encryptedData)
    {
        ...
        cryptPokemon(mutableSpan, pv, SIZE_BLOCK8_BDSP, BLOCK_COUNT8_BDSP);
        ...
        shuffleArray8BDSP(mutableSpan, resultSpan, sv);
    ...
    std::byte* encryptArray8BDSP(std::span<const std::byte> decryptedData, uint32_t personalityValue)
    {
         ...
         *
         * This is the reverse of decryptArray8BDSP. It takes unencrypted, unshuffled

/**
 * Encryption9SV.cpp - Generation 9 Scarlet/Violet Pokemon Encryption/Decryption Implementation
 *
 * Implementation of encryption and decryption utilities.
 * See Encryption9SV.h for detailed documentation.
 */
...
namespace Encryption {
    ...
    std::byte* encryptArray9SV(std::span<const std::byte> decryptedData, uint32_t personalityValue)
    {
         ...
         *
         * This is the reverse of decryptArray9SV. It takes unencrypted, unshuffled
